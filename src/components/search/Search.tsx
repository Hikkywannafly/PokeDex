            ...
            <div className="w-full">
                <div className="flex">
                    ...
                    <div className="relative w-full flex-1">
                        <input type="search" id="search-dropdown" className="outline-none drop-shadow-xl lg:p-4  p-3 block  w-full z-20 text-sm lg:text-base text-gray-900  rounded-lg   hover:drop-shadow-[1px_1px_3px_#acd6ff] duration-150 " placeholder="Search your Pokemon" required>
                        </input>
